...
public class ddls {
	...
	public static void main(String[] args) {
	    ...
	    // 서평 테이블 생성 SQL 쿼리
	    createTableQuery = "CREATE TABLE tblNote ("
	                            + "seq NUMBER PRIMARY KEY, "
	    ...
	    // 서평 시퀀스 생성 SQL 쿼리
        createSequenceQuery = "CREATE SEQUENCE note_seq "
                + "START WITH 1 "
                + "INCREMENT BY 1";
	    ...
	    // 문장 보관함 테이블 생성 SQL 쿼리
	    createTableQuery = "CREATE TABLE tblBookmark ("
	                            + "seq NUMBER PRIMARY KEY, "
	                            + "bookReview_seq NUMBER NOT NULL, "
	                            + "content VARCHAR2(4000) NOT NULL, "
	    ...
	    // 문장 보관함 시퀀스 생성 SQL 쿼리
        createSequenceQuery = "CREATE SEQUENCE bookmark_seq "
                + "START WITH 1 "
                + "INCREMENT BY 1";
